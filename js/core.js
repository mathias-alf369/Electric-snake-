...
(() => {
  ...
  const state = {
    ...
    unlockedNormal: Math.max(ENDLESS_LEVEL, Number(window.__ES_STORAGE__.getItem('electric-snake-unlocked-normal') || ENDLESS_LEVEL)),
    unlockedHard: Math.max(ENDLESS_LEVEL, Number(window.__ES_STORAGE__.getItem('electric-snake-unlocked-hard') || ENDLESS_LEVEL))
  };

  // ALL LEVELS UNLOCKED VERSION: keep both difficulties open, including Endless Storm.
  state.unlockedNormal = ENDLESS_LEVEL;
  state.unlockedHard = ENDLESS_LEVEL;
  window.__ES_STORAGE__.setItem('electric-snake-unlocked-normal', String(ENDLESS_LEVEL));
  window.__ES_STORAGE__.setItem('electric-snake-unlocked-hard', String(ENDLESS_LEVEL));
...
// ============================================================
  ...
  function setCurrentUnlocked(val){
    if(state.difficulty === 'hard'){
      state.unlockedHard = val;
      window.__ES_STORAGE__.setItem('electric-snake-unlocked-hard', String(val));
    } else {
      state.unlockedNormal = val;
      window.__ES_STORAGE__.setItem('electric-snake-unlocked-normal', String(val));
    }
  }
